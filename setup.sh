...
# dotfiles
ln -snvf "$HOME/dotfiles/shell/zshrc" "$HOME/.zshrc"
ln -snvf "$HOME/dotfiles/shell/bashrc" "$HOME/.bashrc"
ln -snvf "$HOME/dotfiles/shell/profile" "$HOME/.profile"
ln -snvf "$HOME/dotfiles/shell/hushlogin" "$HOME/.hushlogin"
mkdir -p "$HOME/.config"
